...
namespace BuildVisualizer.ToolWindow
{
	...
	public class BuildVisualizerToolWindow : ToolWindowPane
	{
		...
		public BuildVisualizerToolWindow() : base(null)
		{
			...
			UserSettingsService userSettingsService = BuildVisualizerPackage.UserSettingsService;

			// This is the user control hosted by the tool window; Note that, even if this class implements IDisposable,
			// we are not calling Dispose on this object. This is because ToolWindowPane calls Dispose on
			// the object returned by the Content property.
			Content = new BuildVisualizerToolWindowControl(solutionService, buildEventService, solutionEventsService, themeService, dte, solution, buildManager, uiShell, diagnosticsService, projectConfigurationService, userSettingsService);
		}
	}
}
